...
#' @usage LoadMeta(PID, UseExample = "default", DataPath = NULL)
...
#' @usage MetaRefer(PID, OutPath = "default", Mode = "search",
#'     VarX = "default", VarY = "default", VarM = "default", YearFrom = "default",
#'     YearEnd = "default", PMID = "default")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitMeta.
...
#' @param Mode chr. Two modes are provided. "Search" for paper retrieval by keywords VarX/VarY/VarM/YearFrom/YearEnd, and "Download" for downloading information (main information only) for specified PMID.
...
#' @param YearFrom chr. "default" or a year character (separate different values by ","). Limits the time range searched for "search" mode. If "default", the function will use the YearFrom values in the file loaded by LoadMeta. If a character (separate different values by ","), the function will use the YearFrom in the character instead.
#' @param YearEnd chr. "default" or a year character (separate different values by ","). Limits the time range searched for "search" mode. If "default", the function will use the YearEnd values in the file loaded by LoadMeta. If a character (separate different values by ","), the function will use the YearEnd in the character instead.
#' @param PMID chr. "default" or a PMID character (separate different values by ","). Refers to the papers PMID for "download" mode. If "default", the function will use the PMID values in the file loaded by LoadMeta. If a character (separate different values by ","), the function will use the PMIDs in the character instead.
...
#' @examples res <- InitMeta()
#'    res1 <- LoadMeta(PID = res$PID, UseExample = "example#1",  DataPath = NULL)
#'    res2 <- MetaRefer(PID = res$PID, OutPath = "default", Mode = "search",
#'    VarX = "default", VarY = "default", VarM = "default", YearFrom = "default",
#'    YearEnd = "default", PMID = "default")
#' @author Weinan Lin, Bin Wang (corresponding author)

MetaRefer = function(PID,
                     OutPath = "default",
                     Mode = "search",
                     VarX = "default",
                     VarY = "default",
...
#' @usage VizRefer(PID, OutPath = "default")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitMeta.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default", the current working directory will be set. It should be noted that the slash symbol is "/", not "\".
...
#'    VarX = "default", VarY = "default", VarM = "default", YearFrom = "default",
#'    YearEnd = "default", PMID = "default")
#'    res3 <- VizRefer(PID=res$PID, OutPath = "default")
#' @author Weinan Lin, Bin Wang (corresponding author)

VizRefer = function(PID,
                    OutPath = "default"){
  if(OutPath == 'default'){
    OutPath = getwd()
  }
...
#' @usage MetaReview(PID, OutPath = "default", CID = "default", DID = "default")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitMeta.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default", the current working directory will be set. It should be noted that the slash symbol is "/", not "\".
...
#' @usage MetaEffect(PID, OutPath = "default", CID = "default", DID = "default")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitMeta.
#' @param OutPath chr. Output file directory, e.g. "D:/output". If "default", the current working directory will be set. It should be noted that the slash symbol is "/", not "\".
#' @param CID chr. "default" or a chemical ID character (separate different values by ","). If "default", the function will use the Chemical_ID values in the file loaded by LoadMeta. If a character (separate different values by ","), the function will use the chemical ID in the character instead. Chemical_ID refers to the target chemical ID which can be inchikey (eg. JIAARYAFYJHUJI-UHFFFAOYSA-L ), cas.rn (eg. 7784-42-1) or our EXC ID (eg. EX:C01631).
#' @param DID chr. "default" or a disease ID character (separate different values by ","). If "default", the function will use the Disease_ID values in the file loaded by LoadMeta. If a character (separate different values by ","), the function will use the disease ID in the character instead. Disease_ID refers to the target disease ID which can be MESH ID (format like MESH:D006973), OMIM ID (format like OMIM:182940) or our EXD ID (eg. EX:D16243)
...
MetaEffect = function(PID,
  ...
  return(results[c("MetaEffect_References","MetaEffect_Plot")])
}
...
#' @details End the module analysis, which must be run after analysis.
#' @return Exit status
#' @export
#' @examples res <- InitMeta()
#'    res1 <- LoadMeta(PID = res$PID,
